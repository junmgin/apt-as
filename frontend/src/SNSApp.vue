        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="defectRegistrations"
                        to="/registrations/defectRegistrations"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="defectManagements"
                        to="/managements/defectManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="defectContractors"
                        to="/contractors/defectContractors"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: 'DefectRegistration', 
                description: '', 
                key: 'defectRegistrations', 
                route: '/registrations/defectRegistrations',
                ImageUrl: '',
            },
            { 
                ...
                description: '', 
                key: 'defectManagements', 
                route: '/managements/defectManagements',
                ImageUrl: '',
            },
            { 
                title: 'DefectContractor', 
                description: '', 
                key: 'defectContractors', 
                route: '/contractors/defectContractors',
                ImageUrl: '',
            },
